...
///! Formatting: Defines a container for content that should be hidden when the page loads
...
///! Formatting: Isolates a part of text that might be formatted in a different direction from other text outside it
...
///! Formatting: Not supported in HTML5. Use CSS instead. Defines font, color, and size for text
...
///! Formatting: Defines what to show in browsers that do not support ruby annotations
CREATE_BODY_BLOCK_COMPONENT(rp);
///! Formatting: Defines an explanation/pronunciation of characters (for East Asian typography)
...
///! Formatting: Not supported in HTML5. Use del or s instead. Defines strikethrough text
...
///! Formatting: Defines some text that is unarticulated and styled differently from normal text
...
///! Frames: Not supported in HTML5. Defines an alternate content for users that do not support frames
...
///! Images: Used to draw graphics, on the fly, via scripting (usually JavaScript)
...
///! Audio / Video: Defines multiple media resources for media elements (video, audio and picture)
...
///! Links: Defines the relationship between a document and an external resource (most used to link to style sheets)
...
///! Tables: Specifies column properties for each column within acolgroup element
...
///! Styles and Semantics: Defines additional details that the user can view or hide
...
///! Styles and Semantics: Adds a machine-readable translation of a given content
...
///! <form>	Specifies the character encodings that are to be used for the form submission
  ...
  ///! Global Attributes	Used to store custom data private to the page or application
  template <const_string key = "None", const_string value = "None"> class $data_ : body_element {        
  public:                                                                      
    std::string &content;                                                      
    std::map<std::string, std::string> pairs;                                  
...
///! Global Attributes	Specifies one or more class names for an element (refers to a class in a style sheet)
...
///! Global Attributes	Specifies the text of the enter-key on a virtual keyboard
...
///! <button>, <input>	Specifies what happens to the popover element when the button is clicked
...
///! Meta Info: Specifies the base URL/target for all relative URLs in a document
CREATE_BODY_INLINE_COMPONENT(base);
///! Meta Info: Not supported in HTML5. Use CSS instead. Specifies a default color, size, and font for all text in a document
CREATE_BODY_BLOCK_COMPONENT(basefont);

///! Programming: Defines a client-side script
CREATE_BODY_BLOCK_COMPONENT(script);
///! Programming: Defines an alternate content for users that do not support client-side scripts
CREATE_BODY_BLOCK_COMPONENT(noscript);
///! Programming: Not supported in HTML5. Useembed orobject instead. Defines an embedded applet
